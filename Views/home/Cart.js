...
//                totalPrice.textContent = sumPrice.toLocaleString('vi-VN') + ' VNĐ';
    ...
    function renderCartItems(sumPrice) {	
		...
		// Sửa số lượng giỏ hàng thì nhập số lượng ở ô input rồi nhấn cập nhật
    ...
    function removeCartItem(id, productPrice) {
        fetch(`http://localhost/StoreToys-BE/API/Cart?id=${id}`, {
            method: 'DELETE'
